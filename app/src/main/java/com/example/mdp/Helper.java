...
//      put("41", R.drawable.bullseye);
      ...
      put("37n", R.drawable.image_id_37_n);
      put("37e", R.drawable.image_id_37_e);
      put("37s", R.drawable.image_id_37_s);
      put("37w", R.drawable.image_id_37_w);

      put("38n", R.drawable.image_id_38_n);
      put("38e", R.drawable.image_id_38_e);
      put("38s", R.drawable.image_id_38_s);
      put("38w", R.drawable.image_id_38_w);

      put("39n", R.drawable.image_id_39_n);
      put("39e", R.drawable.image_id_39_e);
      put("39s", R.drawable.image_id_39_s);
      put("39w", R.drawable.image_id_39_w);

    ...
    public class Bluetooth extends AppCompatActivity {
        ...
        //private static final UUID myUUID = UUID.fromString("61043404-0605-41e8-bab8-6223a37c54c0");
        ...
        private void checkBTPermissions() {
            ...
            if (androidVersion >= 34) { // Android 14 (API 34+)
                requestBluetoothPermissions(new String[]{Manifest.permission.BLUETOOTH_CONNECT, Manifest.permission.BLUETOOTH_SCAN});
            } else if (androidVersion >= Build.VERSION_CODES.S) { // Android 12-13 (API 31-33)
                requestBluetoothPermissions(new String[]{Manifest.permission.BLUETOOTH_CONNECT, Manifest.permission.BLUETOOTH_SCAN});
            } else if (androidVersion >= Build.VERSION_CODES.Q) { // Android 10-11 (API 29-30)
                requestBluetoothPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION});
            } else {
                Log.d(TAG, "checkBTPermissions: No need to check permissions for older versions.");
            }
        }
    
        private void requestBluetoothPermissions(String[] permissions) {
        ...
        public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
            ...
            if (requestCode == PERMISSION_REQUEST_CODE) {
                ...
                if (!allGranted) {
                    Toast.makeText(this, "Bluetooth permissions are required for proper functionality", Toast.LENGTH_SHORT).show();
                }
            }
        }
        ...
        private BroadcastReceiver connectionWatcher = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (status.equals("connected")) {
                    ...
                    connStatusTextView.setTextColor(getResources().getColor(R.color.dark_green));
                    editor.commit();
        ...
        public void startBTConnection(BluetoothDevice device, UUID uuid) {
            ...
            Log.d(TAG, "The UUID is: " + uuid.toString());
